...
func SuggestSearch(esClient *es.ESClient, index, value, field string) (*model.ESSuggestResponse, error) {
	res, err := esClient.Search(
		esClient.Search.WithContext(context.Background()), esClient.Search.WithIndex(index),
		esClient.Search.WithBody(buildSuggestQuery(value, field)),
	...
	var result model.ESSuggestResponse
